...
(
	ClassRequestId UNIQUEIDENTIFIER PRIMARY KEY DEFAULT NEWID(),
	RequestDate DATETIME DEFAULT GETDATE(),
	RequestContent NVARCHAR(255),
	RequestStatus INT DEFAULT 1,
	
	StudentId UNIQUEIDENTIFIER REFERENCES Student(StudentId),
	ClassId UNIQUEIDENTIFIER REFERENCES Class(ClassId),
)
GO

CREATE TABLE EditResultRequest
(
	EditResultRequestID UNIQUEIDENTIFIER PRIMARY KEY DEFAULT NEWID(),
	RequestDate DATETIME DEFAULT GETDATE(),
	RequestContent NVARCHAR(255),
	RequestStatus INT DEFAULT 1,
	
	StudentId UNIQUEIDENTIFIER REFERENCES Student(StudentId),
	ResultId UNIQUEIDENTIFIER REFERENCES Result(ResultId),
)
GO
